...
def create_run(engine, game_name, sav_filename):
    with engine.connect() as conn:
        result = conn.execute(
            text("INSERT INTO runs (game, sav_filename, started_at, is_active) "
...
def setup_new_run(game_name, sav_filename):
    # deactivate all existing runs first
    with engine.connect() as conn:
...
if __name__ == "__main__":
    setup_new_run("Storm Silver", "GameSave-a226e7265da21ab17b3a0f27b992becd5435033e-gameSave")
